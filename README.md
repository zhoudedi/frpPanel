...
首先将项目 clone 到本地
```
git clone https://github.com/ZeroDream-CN/frpPanel/
```
接着移动到网站目录，并设置权限
```
mv frpPanel/* /data/wwwroot/my.panel.com/
...
如需用于商业行为（例如出租内网穿透），或者需要技术支持，请与我 [联系](https://github.com/ZeroDream-CN/frpPanel/issues/21)。
